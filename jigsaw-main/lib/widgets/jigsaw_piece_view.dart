...
class JigsawPieceView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final pieceWidth = decodedWidth / gridSize;
    final pieceHeight = decodedHeight / gridSize;
    final offsetX = -col * pieceWidth;
    final offsetY = -row * pieceHeight;

    final pixelPieceCore = SizedBox(
      width: pieceWidth,
      height: pieceHeight,
      child: CustomPaint(
        foregroundPainter: JigsawOutlinePainter(
          profile: profile,
        ...
        child: ClipPath(
          ...
          child: Transform.translate(
            ...
            child: SizedBox(
              width: decodedWidth.toDouble(),
              height: decodedHeight.toDouble(),
              child: Image.memory(
                fullImageBytes,
                width: decodedWidth.toDouble(),
                height: decodedHeight.toDouble(),
